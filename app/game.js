 ...
 */
function HitShipGame(id, idPlayer1, idPlayer2) {
  this.id = id;
...
/**
 * Bekommt die socket ID für die Spieler
 * @param {type} player
 * @returns {undefined}
 */
HitShipGame.prototype.getPlayerId = function(player) {
  return this.players[player].id;
};

/**
 * Bekommt die socket ID des gewonnenen Spielers
 * @returns {HitShipGame.prototype@arr;players@pro;id}
 */
HitShipGame.prototype.getWinnerId = function() {
...
/**
 * Bekommt die socket ID des verlorenen Spielers
 * @returns {HitShipGame.prototype@arr;players@pro;id}
 */
HitShipGame.prototype.getLoserId = function() {
  if(this.winningPlayer === null) {
    return null;
  }
 ...
 * Switch turns
 */
HitShipGame.prototype.switchPlayer = function() {
  this.currentPlayer = this.currentPlayer === 0 ? 1 : 0;
};

/**
 * Bricht das Spiel ab
 * @param {Number} player Anfrage von
 */
HitShipGame.prototype.abortGame = function(player) {
  // Der Herausfoderer gewinnt
 ...
 */
HitShipGame.prototype.shoot = function(position) {
 ...
 * @returns {HitShipGame.prototype.getGameState.HitShipGameAnonym$0}
 */
HitShipGame.prototype.getGameState = function(player, gridOwner) {
  return {
 ...
 * @returns {HitShipGame.prototype.getGridState.HitShipGameAnonym$0}
 */
HitShipGame.prototype.getGrid = function(player, hideShips) {
  return {
